<template>
  <div ref="lineBarChart" :id="chid" style="height: 670px; width: 1250px"></div>
</template>
...
export default {
  ...
  methods: {
    drawBar() {
      const chartDom = document.getElementById(this.chid)
      ...
      option = {
        ...
        legend: {
          ...
          itemGap: 20,
          data: ['2022-2021', '2022-2020', '2022-2019', '良好總筆數'],
          inactiveColor: '#ccc',
        },
        xAxis: [
          {
        ...
        series: [
...

          {
            ...
            data: [90, 97, 95, 99, 99, 100, 100, 97, 96, 96, 99, 100],
            symbolSize: 10,
            itemStyle: {
              normal: {
                color: '#37484C',
