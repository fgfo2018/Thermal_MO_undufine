              ...
              <v-col cols="12" class="py-1">
                <v-card outlined class="ml-4">
                  <v-card-text>
                    <v-row>
                      <v-col cols="12" class="">
                        <v-img src="../In-deep-img/04.jpg" />
                      </v-col>
                      <v-col cols="12" class="py-0">
                        <v-data-table
                          class="py-0"
                          :headers="elementImgHeaders"
                          :items="elementImgItems"
                          hide-default-footer
                          dense
                          disable-sort
                          disable-filtering
...
// import Two2X1 from './GRIDs/Two2X1.vue'
import Eight4X2 from './GRIDs/Eight4X2.vue'
  ...
  data() {
    return {
      ...
      contactHeaders: [
        ...
        { text: '影像ID', sortable: false, value: 'img_id' },
        { text: '自體異常', sortable: false, value: 'error_self' },
        { text: '比照異常', sortable: false, value: 'error_compare' },
        { text: '加總', sortable: false, value: 'total' },
        {
          text: '詳細資訊',
          value: 'actions',
          sortable: false,
